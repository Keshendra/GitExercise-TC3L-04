...
#wind_spell_sound = pygame.mixer.Sound("windsound.mp3")
#wind_explosion_sound = pygame.mixer.Sound("windexplosionsound.mp3")
...
def bosslevel_2_main():
    ...
    while run:
        ...
        if current_time - last_wind_spell_time >= 1000:
